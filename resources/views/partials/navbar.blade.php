<nav class="navbar horizontal-layout col-lg-12 col-12 p-0">
    <div class="container d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top">
            <a class="navbar-brand brand-logo" href="../../index-2.html"><img src="../../images/logo-inverse.svg" alt="logo"/></a>
    ...
    <div class="nav-bottom">
        <div class="container">
            <ul class="nav page-navigation">
                <li class="nav-item {{ active('/archive') }}">
                    <a href="#" class="nav-link"><i class="link-icon fa fa-archive"></i><span class="menu-title">ARCHIVED</span></a>
                </li>
                <li class="nav-item {{ active('/') }}">
                    <a href="#" class="nav-link"><i class="link-icon fa fa-clock-o"></i><span class="menu-title">CURRENT</span></a>
                </li>
                <li class="nav-item {{ active('/create') }}">
                    <a href="#" class="nav-link"><i class="link-icon fa fa-plus-circle"></i><span class="menu-title">CREATE</span></a>
                </li>
